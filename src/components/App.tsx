...
const contractAddress = "0x00ffb107d88408f25bbbc4b67b160e3d1c9358b0dca863910b0f41f754c7eaa9";
...
function App() {
    ...
    const current_block_hash = async () => {
        try {
           const provider1 = new SequencerProvider({baseUrl: constants.BaseUrl.SN_GOERLI}); //Sequncer provider is depreciated.
        ...
        <div>
            ...
            { isConnected ?
                <div>
                    ...
                    <p>Balance.</p>
                    <p>{balance}</p>
                    <p><button onClick={() => checkBlance()}>Check Balance</button></p>
                    <hr />
                    <p>Transfer</p>
                    <p>Recipient:
                        <input
